import {
  ...
  //Track product
  export const trackProducts = (tracking_no) => {
    return (dispatch) => {
      dispatch({
      ...
      axios
        .get(config.baseUrl + `/track/${tracking_no}`)
        .then((res) => {
          ...
          if (res.data.trackingJson !== null) {
            console.log(res.data.trackingJson)
            dispatch({
  ...
  export const createTrack = (
    ...
    return (dispatch) => {
      ...
      axios
        .post(config.baseUrl + '/track/', data)
        .then((res) => {
          dispatch({
            type: CREATING_TRACK,
            payload: false,
  ...
  export const updateTracking = (trackingNo, trackingDescription, location,estdeliveryDate, status) => {
    ...
    return (dispatch) => {
      if (trackingNo === "" || location === "" || trackingDescription === ""||estdeliveryDate === ""||status==="") {
        ...
        axios
          .get(config.baseUrl + `/track/tracking_no=${trackingNo}`)
          .then((res) => {
