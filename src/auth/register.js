...
class Register extends Component {
  render() {
    const { username, email, password, registeringUser, regErr } = this.props;
    return (
      <div>
          ...
          <div className="login-form clrbg-before">
            <form className="login">
              ...
              <div className="form-group">
                <div
                  onClick={() =>
                    this.props.registerCustomer(username, email, password)
                  }
                  className="btn-1 "
                  type="submit"
                >
...
const mapStateToProps = (state) => {
  const { username, email, password } = state.General;
